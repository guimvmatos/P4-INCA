...
/* get scalars.metadata@next_srv6_sid [32;0] */
uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__0(EXTRACTED_HEADERS_T *extracted_headers);

/* get scalars.metadata@next_srv6_sid [32;32] */
uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__1(EXTRACTED_HEADERS_T *extracted_headers);

/* get scalars.metadata@next_srv6_sid [32;64] */
uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__2(EXTRACTED_HEADERS_T *extracted_headers);

/* get scalars.metadata@next_srv6_sid [32;96] */
uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__3(EXTRACTED_HEADERS_T *extracted_headers);

/* set scalars.metadata@next_srv6_sid [32;0] */
void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__0(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* set scalars.metadata@next_srv6_sid [32;32] */
void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__1(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* set scalars.metadata@next_srv6_sid [32;64] */
void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__2(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);

/* set scalars.metadata@next_srv6_sid [32;96] */
void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__3(EXTRACTED_HEADERS_T *extracted_headers, uint32_t val);
...
__forceinline uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__0(EXTRACTED_HEADERS_T *extracted_headers)
{
    ...
    return PIF_HEADER_GET_scalars___metadata__next_srv6_sid___0(md);
}

__forceinline uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__1(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    return PIF_HEADER_GET_scalars___metadata__next_srv6_sid___1(md);
}

__forceinline uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__2(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    return PIF_HEADER_GET_scalars___metadata__next_srv6_sid___2(md);
}

__forceinline uint32_t pif_plugin_meta_get__scalars__metadata__next_srv6_sid__3(EXTRACTED_HEADERS_T *extracted_headers)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    return PIF_HEADER_GET_scalars___metadata__next_srv6_sid___3(md);
}

__forceinline void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__0(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    PIF_HEADER_SET_scalars___metadata__next_srv6_sid___0(md, val);
}

__forceinline void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__1(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    PIF_HEADER_SET_scalars___metadata__next_srv6_sid___1(md, val);
}

__forceinline void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__2(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    PIF_HEADER_SET_scalars___metadata__next_srv6_sid___2(md, val);
}

__forceinline void pif_plugin_meta_set__scalars__metadata__next_srv6_sid__3(EXTRACTED_HEADERS_T *extracted_headers,uint32_t val)
{
    __lmem struct pif_header_scalars *md = (__lmem struct pif_header_scalars *)(((__lmem uint32_t *)extracted_headers) + PIF_PARREP_scalars_OFF_LW);
    PIF_HEADER_SET_scalars___metadata__next_srv6_sid___3(md, val);
}
